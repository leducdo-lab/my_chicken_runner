...
public class ChickenRunnerView extends JFrame{
	...
	public ChickenRunnerView() {
		...
		this.setTitle("My Chicken Runner");
		this.setResizable(false);
		this.getContentPane().setPreferredSize(new Dimension(Constrants.FRAME_WIDTH, Constrants.FRAME_HEIGHT));
		this.pack();
